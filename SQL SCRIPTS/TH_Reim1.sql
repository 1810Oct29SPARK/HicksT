...
INSERT INTO REIMBURSEMENT(AMOUNT, EMPLOYEEID, RESOLVERID, STATUSID, TYPEID)
Values(200.00, 103, 7, 2, 1);

ROLLBACK;


UPDATE REIMBURSEMENT SEt OUNT=150 , EMPLOYEEID=59, RESOLVERID=6,STATUSID= 1,TYPEID= 5
